...
# WELL SMALL LARGE CRC CRC_DEATH NATURAL_DEATH SCREEN_NO_DISEASE SCREEN_DISEASE TREATMENT
TRANS50_DNAScreen_MATRIX = [
    [0,      0.011,       0,     0.00044,       0,      0.0041757,   1/3,  0,   0],  # WELL
    [0,          0,    0.01,           0,       0,      0.0041757,   0,  1/3,   0],  # SMALL
    [0,          0,       0,        0.05,        0,      0.0041757,   0,  1/3,   0],  # LARGE
    [0,          0,       0,           0, 0.013085,      0.0041757,   0,  1/3,   0],  # CRC
    [0,          0,       0,           0,        0,              0,   0,  0,   0],  # CRC_DEATH
    [0,          0,       0,           0,        0,              0,   0,  0,   0],  # NATUAL_DEATH
    [327.77,     0,       0,           0,        0,    0.0041757*r1,   0,  0, 37.23],  # SCREEN_NO_DISEASE
    [0,     302.22,   210.24,      24.455,       0,    0.0041757*r1,   0,  0, 558.085],  # SCREEN_DISEASE
...
print('Transition probability matrix with screening at 45:', TRANS50_DNAScreen_MATRIX)
print('')
